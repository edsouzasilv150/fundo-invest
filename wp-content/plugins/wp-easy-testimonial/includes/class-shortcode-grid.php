...
/**
 * The WT Shortcode Grid class getting testimonials in grid format from the plugin.
 *
...
/**
 * The Grid Testimonials shorcode to display gird testimonial posts from this function
 *
 */
...
class ETP_Shortcode_Grid {
	 ...
	 * and adding wbr-grid-testimonials shorcode
	 *
	 * @param    string    $version
	 */
	public function __construct( $version ) {
		$this->version = $version;
		add_shortcode( 'wbr-grid-testimonials' , array( $this, 'etp_testimonials_grid_callback' ) );
	}
	
	public function etp_testimonials_grid_callback( $atts ){
		global $etp_options,$wtshortcodeatts;
		...
		do_action( 'etp_before_testimonial' , $width );
			echo apply_filters( 'etp_testimonial_grid_html', $output);
		// after testimonial
