...
/**
 * The WT Shortcode Random class getting list of testimonials randomly from the plugin.
 *
...
/**
 * The Random Testimonials shorcode to display radon testimonial posts from this function
 *
 */
...
class ETP_Shortcode_Random {
	 ...
	 * and adding wbr-random-testimonials shorcode
	 *
	 * @param    string    $version
	 */
	public function __construct( $version ) {
		$this->version = $version;
		add_shortcode( 'wbr-random-testimonials' , array( $this, 'etp_testimonials_random_callback' ) );
	}
	
	public function etp_testimonials_random_callback( $atts ){
		global $etp_options;
		...
		do_action( 'etp_before_testimonial' , $width );
			echo apply_filters( 'etp_testimonial_random_html', $output);
		// after testimonial
